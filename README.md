...
* [James McCarthy](https://github.com/JamesMcCarthy79/Home-Assistant-Config) - Regularly updated, well documented runs 3 instances & maintains automation examples in both yaml & Node-RED.
