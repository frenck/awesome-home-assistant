...
* [Remote instances](https://github.com/lukas-hetzenecker/home-assistant-remote) - Link multiple instances together; subscribes to state changes and service calls of other instances and forwards them using the WebSocket API.
