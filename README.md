...
* [Alexa Media Player](https://github.com/keatontaylor/alexa_media_player) - Creates media_player entities for your Amazon Echo devices. Includes text-to-speech capability.  Best when used together with the [Mini Media Player](https://github.com/kalkih/mini-media-player) custom Lovelace card.
