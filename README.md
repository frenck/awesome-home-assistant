...
- [Xcene IR Code Bank](https://xcene.com.br/codigos-ir.html) - Open database of 800+ infrared device codes (air conditioners, TVs, receivers, soundbars) with in-browser converters (NEC to Pronto Hex, Broadlink base64 to raw, Global Cache, Flipper). Data from Flipper-IRDB (CC0) and SmartIR (MIT). Useful for HA IR blaster and Broadlink setups.
